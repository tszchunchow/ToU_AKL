...
_static_assets = ["network_assessment_files","network_assessment_files/libs/quarto-html/tippy.css","network_assessment_files/libs/quarto-html/quarto-syntax-highlighting.css","network_assessment_files/libs/bootstrap/bootstrap-icons.css","network_assessment_files/libs/bootstrap/bootstrap.min.css","network_assessment_files/libs/quarto-dashboard/datatables.min.css","network_assessment_files/libs/clipboard/clipboard.min.js","network_assessment_files/libs/quarto-html/quarto.js","network_assessment_files/libs/quarto-html/popper.min.js","network_assessment_files/libs/quarto-html/tippy.umd.min.js","network_assessment_files/libs/quarto-html/anchor.min.js","network_assessment_files/libs/bootstrap/bootstrap.min.js","network_assessment_files/libs/quarto-dashboard/quarto-dashboard.js","network_assessment_files/libs/quarto-dashboard/stickythead.js","network_assessment_files/libs/quarto-dashboard/datatables.min.js","network_assessment_files/libs/quarto-dashboard/pdfmake.min.js","network_assessment_files/libs/quarto-dashboard/vfs_fonts.js","network_assessment_files/libs/quarto-dashboard/web-components.js","network_assessment_files/libs/quarto-dashboard/components.js"]
_static_assets = {"/" + sa: Path(__file__).parent / sa for sa in _static_assets}

app = App(
    Path(__file__).parent / "network_assessment.html",
    server,
